...
function BottomFooter() {
  return (
    <div className="second-footer py-[16px]">
      <div className="promotion-div flex justify-between items-center w-full max-w-[1200px] m-auto my-[16px]">
        <img src="/src/assets/cartrade_tech.svg" alt="cartrade_tech" />
        <img src="/src/assets/olx.svg" alt="olx" />
        <img src="/src/assets/carwale.svg" alt="carwale" />
        <img src="/src/assets/bikewale.svg" alt="bikewale" />
        <img src="/src/assets/cartrade.svg" alt="cartrade" />
        <img src="/src/assets/mobility.svg" alt="mobility" />
      </div>
  ...
  return (
    <div className="footer">
      <div className="first-footer">
        <div className="first-footer-child flex">
          ...
          <div className="follow-div flex flex-col justify-between">
            <div>
              <span>FOLLOW US</span>
              <div className="social-links flex">
                ...
                >
                  <span role="listbox" tabIndex="0" id="" data-aut-id="">
                    <svg
                      width="48px"
                      height="48px"
            ...
            <div className="store-image-div flex">
